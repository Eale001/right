...
<body style="background-color: #ecf0f5;">
	...
	<div class="row" style="padding-top: 15px;">
		<div class="col-md-12">
			<!--id="container"-->
			<div class="bgc-w box">
				<form action="saveType" method="post" onsubmit="return check();">
					<!--盒子头-->
							...
							<div class="row">
								<div class="col-md-6 form-group">
									<label class="control-label"><span>名称</span></label> <input
										name="typeName" class="form-control" value="${(types.typeName)!''}"/>
								</div>
								<#--<div class="col-md-6 form-group">-->
								...
								<div class="col-md-6 form-group">
									...
									<textarea rows="5" cols="20" name="discription"  class="form-control" style="margin: 0px -0.5px 0px 0px; height: 114px; width: 507px;">${(types.discription)!''}</textarea>
								</div>
								<input type="hidden" name="typeId" value="${(types.typeId)!''}"/>
							</div>
						</div>
					</div>
					<!--盒子尾-->
